function ret = gfigure(display,varargin)
% GFIGURE is...
...
% Settings
%======================================================================
defaultFigsize = [500, 300];  % Default figure size
defaultOrientation = 'col';   % default orientation ('row': left to right, 'col': up to down)
defaultDispPriority = [1 2];  % Order of displays to show figures on
...
if isfield(args,'fighandles')
    ...
    if display == 1
        dispCoords = [1 1 1280 800];
    else
        dispCoords = [1 1 2560 1440];
    end
